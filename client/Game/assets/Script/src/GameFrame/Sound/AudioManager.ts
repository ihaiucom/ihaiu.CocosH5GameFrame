...
export default class AudioManager
{
	...
	private soundPlayingDic: Dictionary<string, any> = new Dictionary<string, any>();
	// 初始化
	install(): void
	{
	...
	playMusic(soundKey: string, loops?: number, complete?: any, startTime?: number): any
	{
		return;
	...
	playSound(soundKey: string, isStopPreSound?: boolean, loops?: number, complete?: any, startTime?: number): any
	{
		return;
		if (!this.soundPlayingDic || this.soundPlayingDic === null)
		{
			// this.soundPlayingDic = new Dictionary<string, SoundChannel>();
			this.soundPlayingDic = new Dictionary<string, any>();
		}
