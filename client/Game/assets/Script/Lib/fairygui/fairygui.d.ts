...
declare namespace fgui {
    class GObject {
        ...
        onClick(target: any, listener: Function): void;
        offClick(target: any, listener: Function): void;
        hasClickListener(): boolean;
        on(type: string, target: any, listener: Function ): void;
        off(type: string, target: any, listener: Function ): void;
        draggable: boolean;
        dragBounds: cc.Rect;
